...
const VideoDetails = () => {
  ...
  const goToNextVideo = () => {
    ...
    if(currentSubSectionIndex !== noOfSubSections - 1) {
        ...
        const nextSubSectionId = courseSectionData[currentSectionIndex].subSections[currentSectionIndex + 1]._id;
        //next video pr jao
  ...
  const goToPrevVideo = () => {
    ...
    if(currentSubSectionIndex != 0 ) {
        ...
        const prevSubSectionId = courseSectionData[currentSectionIndex].subSections[currentSubSectionIndex - 1];
